...
//                       We respond within 1-2 business days. All enquiries are handled with strict confidentiality.
//                     </Text>
//                   </Box>
//                 )}
//               </Box>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "We've received your enquiry and sent a confirmation to your email.",
        status: "success",
        duration: 5000,
        isClosable: true,
        position: "top-right",
          ...
          >
            ...
            >
              ...
              <VStack align="start" spacing={6} mb={10}>
                {[
                  ...
                  },
                  {
                    icon: <PhoneIcon />,
                    label: "Phone",
                    value: "+234 803 885 0854\n+234 803 639 7972",
                  },
                  {
                    icon: <MailIcon />,
                    label: "Email",
                    value: "lightyearconstruct@gmail.com",
                  },
                  {
                    icon: <ClockIcon />,
              ...
              >
                ...
                <Text fontSize="xs" color="stellar.muted" mt={1}>
                  Available for urgent site inquiries
                </Text>
              </Box>
            </MotionBox>
                ...
                {submitted ? (
                  <Box textAlign="center" py={12}>
                    ...
                    >
                      ...
                      email to {form.email}. A member of our team will be in
                  ...
                  <Box as="form" onSubmit={handleSubmit}>
                    ...
                    >
                      We respond within 1-2 business days. All enquiries are
