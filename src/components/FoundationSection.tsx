  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content wrapper that takes full height */}
        <VStack align="stretch" spacing={0} flex={1}>
          ...
          <Box
            ...
            sx={{
              "[role=group]:hover &": { transform: "scale(1.1) rotate(5deg)" },
            }}
          >
            {icon}
          </Box>
          ...
          {/* Body - this will push to fill remaining space */}
          <Text fontSize="sm" color="stellar.muted" lineHeight="1.9" flex={1}>
            {body}
          </Text>

          {/* Bottom gold accent - now properly positioned */}
          <Box
            position="absolute"
            bottom={0}
            left={0}
  ...
  return (
    <Box as="section" py={{ base: 20, md: 28 }} bg="stellar.surface">
      <Box maxW="1280px" mx="auto" px={{ base: 5, md: 8 }}>
        ...
        >
          {PILLARS.map((p, i) => (
            <GridItem key={p.title} display="flex">
